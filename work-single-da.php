  ...
  <div class="container">
    <div class="row">
      <div class="col-12 wow fadeIn">
        ...
        <h2>Deepshika Agarwal</h2>
      </div>
      <!-- end col-12 -->
      <div class="col-lg-5 wow fadeIn">
        <h4>Managing a label designer’s social media.</h4>
      </div>
      <!-- end col-5 -->
    ...
    <div class="text-desc row">
      	<div class="col-12 wow fadeIn" data-wow-delay="0s" style="visibility: visible; animation-delay: 0s; animation-name: fadeIn;">
      		<h5>Description</h5>
      		<p>Mrs Deepshika Agarwal wanted her designs to be presented in a premium manner on social media.</p>
      	</div>
      	<!-- end col-6 -->
