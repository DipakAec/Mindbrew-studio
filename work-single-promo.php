  ...
  <div class="container">
    <div class="row">
      <div class="col-12 wow fadeIn">
        ...
        <h2>ANT Promoskope</h2>
      </div>
      <!-- end col-12 -->
      <div class="col-lg-5 wow fadeIn">
        <h4>Branding exercise for a telecom support brand.</h4>
      </div>
      <!-- end col-5 -->
    ...
    <div class="text-desc row">
      	<div class="col-12 wow fadeIn" data-wow-delay="0s" style="visibility: visible; animation-delay: 0s; animation-name: fadeIn;">
      		<h5>Description</h5>
      		<p>ANT Promoskope was looking for a minimalistic and authoritative identity for their brand.</p>
      	</div>
      	<!-- end col-6 -->
