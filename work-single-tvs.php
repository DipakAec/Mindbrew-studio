  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-5 wow fadeIn">
        <h4>A television commercial for TVS Victor.</h4>
      </div>
      <!-- end col-5 -->
    ...
    <div class="text-desc row">
      	<div class="col-12 wow fadeIn" data-wow-delay="0s" style="visibility: visible; animation-delay: 0s; animation-name: fadeIn;">
      		<h5>Description</h5>
      		<p>TVS was looking for a unique, relatable way to look at the classic two-wheeler, Victor.</p>
      	</div>
      	<!-- end col-6 -->
      ...
      <!-- end col-7 --> 
      <div class="col-12 wow fadeIn">
      <iframe width="100%" height="500" src="https://www.youtube.com/embed/JAGHrscYxbY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
      </div>
           <div class="col-12 wow fadeIn">
