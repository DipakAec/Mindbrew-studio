  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-5 wow fadeIn">
        <h4>An ad montage of Westin’s liquor display.</h4>
      </div>
      <!-- end col-5 -->
    ...
    <div class="text-desc row">
      	<div class="col-12 wow fadeIn" data-wow-delay="0s" style="visibility: visible; animation-delay: 0s; animation-name: fadeIn;">
      		<h5>Description</h5>
      		<p>Westin India wanted a cinematic shoot of their recently installed liquor cabinet.</p>
      	</div>
      	<!-- end col-6 -->
      ...
      <!-- end col-7 --> 
      <div class="col-12 wow fadeIn">
      <iframe width="100%" height="500" src="https://www.youtube.com/embed/6v8v9n8bGT4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
      <!-- end col-12 -->
